...
class Usuario extends \Application\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'senha', '' . "\0" . 'Application\\Entity\\Usuario' . "\0" . 'perfil', 'salt', 'perfilId'];
        }
    ...
    public function encryptSenha($senha)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'encryptSenha', [$senha]);
    ...
    public function setPerfilId($id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPerfilId', [$id]);

        return parent::setPerfilId($id);
    }
